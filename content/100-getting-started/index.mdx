...
您可以 also use Prisma Postgres with different tools or ORMs. Pick one of the options below to see 如何 connect.
...
Working with **Next.js**, **Remix**, or another framework? 您可以 easily add Prisma to your setup in just a few steps and start using it right away.
