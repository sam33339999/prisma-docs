---
title: '開始使用'
metaTitle: '開始使用 with Prisma Optimize'
metaDescription: '學習 如何 quickly set up and 啟動 使用 Prisma Optimize.'
tocDepth: 3
toc: true
---
...
Before you begin with Prisma Optimize, ensure you have 以下:
...
For versions of Prisma ORM between `4.2.0` and `6.1.0`, 您需要 enable the `tracing` preview feature in your Prisma schema file.
...
If you are using [Prisma Accelerate](/accelerate) in your application, make sure you apply it _after_ the Optimize extension. 例如：
