---
title: 'Prisma Accelerate 範例'
metaTitle: 'Prisma Accelerate: 範例'
metaDescription: 'Check out ready-to-執行 範例 for Prisma Accelerate.'
sidebar_label: '範例'
tocDepth: 3
---

Here is a list of ready-to-run example projects that demonstrate 如何使用 Prisma Accelerate:
