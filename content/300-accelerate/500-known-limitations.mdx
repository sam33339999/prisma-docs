---
title: 'Known 限制 關於 Prisma Accelerate'
sidebar_label: 'Known 限制'
metaTitle: 'Accelerate: 限制'
metaDescription: '學習 關於 限制 of Accelerate.'
tocDepth: 3
toc: true
---
...
If you have a use case that 需要 running extremely heavy or long-running queries and Prisma Accelerate, please reach out to us.

## Not 相容於 direct IPv4 addresses in MongoDB connection strings
...
For additional details on Accelerate’s IPv6-first design, 參閱 our [blog post](https://www.prisma.io/blog/accelerate-ipv6-first).