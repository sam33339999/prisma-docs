...
metaDescription: 'Prisma Accelerate is a global 資料庫 cache with built-in 連線 pooling that helps improve 資料庫 效能 in 無伺服器 and 邊緣 applications.'
sidebar_position: 0
...
您可以 configure query-level caching strategies directly in your code with Prisma ORM, making setup and tuning easy.
...
Accelerate 適用於 the database you already have, whether it is publicly accessible, or via an IP allowlist.
