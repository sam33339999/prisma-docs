---
title: '支援'
metaTitle: 'Console: 支援'
metaDescription: 'Find the right 支援 for any Console question.'
tocDepth: 3
toc: true
...
Your support options are based on your workspace's active plan. For more details, 查看 our [pricing page](https://www.prisma.io/pricing).
...
If you want 刪除 your PDP account, **email us at [support@prisma.io](mailto:support@prisma.io)** specifying the email id or GitHub handle with which you signed up. 
