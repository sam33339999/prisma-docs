---
title: 'MDX 元件'
metaTitle: 'MDX 元件 in the Prisma docs'
metaDescription: 'MDX 元件 元件 available on the Prisma 文件 site.'
sidebar_label: 'MDX 元件'
search: false
---

<TopBlock>

本頁描述 如何使用 the custom [MDX](https://mdxjs.com/) components (e.g. code blocks) in the Prisma docs.
...
預設情況下, all the code blocks will have a `copy` icon for copying the code. If you want to disable the `copy` option in the code block, please use `no-copy` property.
...
Next, choose how you want 設定 your database:
