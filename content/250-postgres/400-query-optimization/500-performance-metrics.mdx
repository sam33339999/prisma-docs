---
title: '效能 metrics'
metaTitle: 'Prisma Postgres: 查詢 效能 metrics'
...
The maximal query duration measures the time taken by the single slowest query. This metric helps identify extreme cases, providing insights into the worst performance scenarios your system might face, so 您可以 diagnose and resolve outliers.
