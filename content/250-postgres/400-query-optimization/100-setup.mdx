---
title: '設定'
metaTitle: '開始使用 with optimizing queries in Prisma Postgres'
metaDescription: '學習 如何 quickly set up and 啟動 optimizing Prisma Postgres queries.'
tocDepth: 3
toc: true
---
...
Before you begin with Prisma Optimize for Prisma Postgres, ensure you have 以下:
...
5. Click the copy icons to continue through each setup screen until you 參見 **Finish & optimize** button. Click that to complete the setup.
...
Run 以下 command in your terminal 安裝 the necessary dependencies:
