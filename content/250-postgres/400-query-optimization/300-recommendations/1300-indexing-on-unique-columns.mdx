---
title: 'Indexing on 唯一 columns'
metaTitle: 'Optimize recommendations: Indexing on 唯一 columns'
metaDescription: "學習 關於 the recommendation provided by Optimize regarding indexing on uniquely constrained columns."
tocDepth: 3
toc: true
---
