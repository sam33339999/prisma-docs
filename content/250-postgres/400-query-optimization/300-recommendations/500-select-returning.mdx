---
title: 'Overfetching'
metaTitle: 'Optimize 建議: `SELECT/RETURNING *`'
metaDescription: "學習 關於 the recommendation provided by Optimize for 查詢 that are overfetching 資料."
tocDepth: 3
toc: true
---
...
以下 query might be overfetching data in queries on the `User` model:
