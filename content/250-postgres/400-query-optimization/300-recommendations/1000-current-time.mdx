---
title: '使用 CURRENT_TIME'
metaTitle: 'Optimize Recommendations: Avoid usage of `CURRENT_TIME`'
metaDescription: '學習 關於 the recommendation provided by Optimize for 使用 the `CURRENT_TIME` function'
tocDepth: 2
toc: true
---

以下 raw SQL query uses the `CURRENT_TIME` function:
