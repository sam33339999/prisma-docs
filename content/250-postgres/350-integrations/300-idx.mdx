...
metaDescription: '學習 如何 use Prisma Postgres in the online Firebase Studio.'
tocDepth: 3
toc: true
---

If you want to explore Prisma Postgres without leaving your browser, 您可以 try it out the via Google's [Firebase Studio](https://studio.firebase.google.com/), a fully-fledged online IDE:
