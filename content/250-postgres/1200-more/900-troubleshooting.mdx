---
title: '疑難排解 Prisma Postgres issues'
sidebar_label: '疑難排解'
metaTitle: '疑難排解 Prisma Postgres issues'
metaDescription: '學習 關於 疑難排解 Prisma Postgres issues.'
tocDepth: 3
toc: true
---
...
Running 以下 command fails because the `--db` option is not recognized:
...
You may encounter 以下 error message in your logs:
...
To resolve this issue, consider 以下 options:
...
- Ensure that you are logged into the correct account in the Prisma CLI. For more details on authentication and account management, please 參閱 the [Prisma CLI documentation](/platform/platform-cli/commands#authentication).
