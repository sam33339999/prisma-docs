...
metaDescription: "A lightweight PostgreSQL driver for Prisma Postgres optimized for serverless and 邊緣 environments with HTTP/WebSocket 支援, result streaming, and minimal memory footprint."
tocDepth: 3
toc: true
