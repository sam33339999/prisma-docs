...
metaDescription: '學習 如何 use Prisma Studio directly in VS Code.'
tocDepth: 3
toc: true
---
...
您可以 use Prisma Studio directly in VS Code via the [Prisma VS Code extension](https://marketplace.visualstudio.com/items?itemName=Prisma.prisma).
