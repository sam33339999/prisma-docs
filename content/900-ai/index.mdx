---
title: '建置 faster with Prisma + AI'
metaTitle: 'AI'
metaDescription: 'AI'
staticLink: true
---
...
Run 以下 command to bootstrap your database with a prompt:
...
Prisma ORM and Prisma Postgres integrate seamlessly with your AI coding tools. 查看 our documentation with tips and tricks for working with Prisma in various AI editors.
...
<Grid>
  ...
  <LinkCard
    ...
    title="ChatGPT"
    desc="學習如何 connect the Prisma MCP server to ChatGPT to manage your databases with natural language."
...
<HomepageCard
  ...
  body={`學習如何 integrate Prisma’s MCP server in your favorite AI tool, such as Cursor, Claude, Warp, and more.`}
/>
<HomepageCard
  light
  heading={
...
<HomepageCard
  ...
  body={`Software development is rapidly changing with AI coding tools. This article shows 如何 harness productivity gains while staying in control — and why understanding your code still matters.`}
/>
<HomepageCard
  light
  heading={
...
<HomepageCard
  ...
  body={`學習如何 build a chat application using the Vercel AI SDK with Next.js and Prisma ORM to store chat sessions and messages in a Prisma Postgres database.`}
/>
</Grid>
...
<HomepageCard
  ...
  body={`Connect Prisma Postgres to other apps 建立 powerful automations and data workflows, such as automatically spinning up a new database when a customer signs up in Stripe or connecting your database with Slack, Notion, Airtable, or any other app in the Pipedream ecosystem.`}
/>
<HomepageCard
  light
  heading={
