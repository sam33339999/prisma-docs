---
title: 'REST API'
metaTitle: '升級 a REST API from Prisma 1 to Prisma ORM 2'
metaDescription: '學習 如何 升級 a REST API from Prisma 1 to Prisma ORM 2.'
---

## 概述

This upgrade guide describes 如何 migrate a Node.js project that's based on [Prisma 1](https://github.com/prisma/prisma1) and uses the [Prisma 1 client](https://v1.prisma.io/docs/1.34/prisma-client/) to implement a REST API.
...
## 1. Adjust the application 使用 Prisma Client 2
...
Consider each occurrence of the Prisma Client instance `prisma` and replacing with the respective usage of Prisma Client 2. 您可以 learn more in the [API Reference](/orm/prisma-client).
...
請注意 this only imports the `PrismaClient` constructor, so you also need to instantiate a Prisma Client 2 instance:
