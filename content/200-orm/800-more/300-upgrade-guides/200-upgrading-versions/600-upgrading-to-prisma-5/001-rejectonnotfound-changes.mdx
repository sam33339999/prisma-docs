...
metaTitle: '如何 handle removal of rejectOnNotFound in Prisma ORM 5'
metaDescription: 'Sub-指南 explaining 如何 update your code due to the removal of rejectOnNotFound in Prisma ORM 5'
tocDepth: 2
toc: true
---
