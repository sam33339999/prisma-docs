---
title: '程式碼轉換工具'
metaTitle: '程式碼轉換工具 (指南s)'
metaDescription: 'Use 程式碼轉換工具 to 升級 your codebase as Prisma ORM evolves.'
---

:::info Quick summary
本頁說明 如何使用 Prisma's codemods to automatically update your codebase during major version upgrades. 學習關於 installation, usage commands, available code transformations, and options for safely refactoring your projects.
:::
...
您可以 checkout the repository, here: https://github.com/prisma/codemods
