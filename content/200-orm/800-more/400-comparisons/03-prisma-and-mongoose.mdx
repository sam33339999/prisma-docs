...
metaDescription: '學習 how Prisma ORM compares to Mongoose.'
community_section: true
---

<TopBlock>

This page compares the Prisma ORM and [Mongoose](https://mongoosejs.com/docs/guide.html) APIs. If you want to 學習如何 migrate from Mongoose to Prisma, 查看 this [guide](/guides/migrate-from-mongoose).
...
Mongoose doesn't offer a dedicated API for relation filters. 您可以 get similar functionality by adding an additional step to filter 結果s returned by the query.
