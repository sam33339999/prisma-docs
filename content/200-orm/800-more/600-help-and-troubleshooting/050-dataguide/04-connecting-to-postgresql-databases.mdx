...
metaTitle: "Connecting to PostgreSQL databases | Prisma's Data 指南"
metaDescription: "Before you can manage your data with PostgreSQL, you need to be able to connect to the 資料庫 server. In this 指南, we'll use the `psql` command line 客戶端 to demonstrate 如何 connect to PostgreSQL databases."
