...
metaTitle: "Connecting to PostgreSQL databases | Prisma's 資料 指南"
metaDescription: "Before you can 管理 your 資料 with PostgreSQL, you need to be able to 連接 to the 資料庫 server. In this 指南, we'll use the `psql` command line 客戶端 to demonstrate 如何 connect to PostgreSQL databases."
