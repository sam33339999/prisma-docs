---
title: 'Modeling and querying 多對多 relations'
metaTitle: 'Modeling and querying 多對多 relations'
metaDescription: '學習 how you can 模型 and 查詢 implicit and explicit 多對多 relations with Prisma ORM'
tocDepth: 3
---
...
建立 a post and its tags, one can write this with Prisma Client:
...
Another use case for this is if you want 添加 new tags as well as connect to existing tags to a post. An example for this is where a user has created new tags for their post and has also selected existing tags to be added as well. In this case, we can perform this in 以下 way:
...
這將 provide an output similar to the one you received with implicit relations.
...
This article showed how 您可以 implement implicit and explicit many-to-many relations and query them using Prisma Client.
