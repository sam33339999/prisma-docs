---
title: Native 資料庫 functions
metaTitle: Native 資料庫 functions
metaDescription: 如何 enable PostgreSQL native 資料庫 functions for projects that use Prisma Migrate.
---
