---
title: 'Unsupported 資料庫 功能 (Prisma Migrate)'
sidebar_label: 'Unsupported 資料庫 功能'
metaTitle: 'Prisma Migrate: Unsupported 資料庫 功能'
metaDescription: '如何 include unsupported 資料庫 功能 for projects that use Prisma Migrate.'
---

<TopBlock>

Prisma Migrate uses the Prisma schema to determine what features 建立 in the database. However, some database features [cannot be represented in the Prisma schema](/orm/prisma-schema/data-model/unsupported-database-features) , including but not limited to:
...
添加 an unsupported feature to your database, 您必須 [customize a migration](/orm/prisma-migrate/workflows/customizing-migrations) to include that feature before you apply it.
...
1. Open the generated `migration.sql` file and add the unsupported feature - 例如, a partial index:
