---
title: '概述 on Prisma Migrate'
sidebar_label: '概述'
metaTitle: 'Prisma Migrate 概述'
metaDescription: '學習 everything you need to know 關於 Prisma Migrate.'
...
If you are prototyping, consider using the [`db push`](/orm/reference/prisma-cli-reference#db-push) command - see [Schema prototyping with `db push`](/orm/prisma-migrate/workflows/prototyping-your-schema) 例如s.

:::

參見 [Prisma Migrate reference](/orm/reference/prisma-cli-reference#prisma-migrate) for detailed information about the Prisma Migrate CLI commands.
