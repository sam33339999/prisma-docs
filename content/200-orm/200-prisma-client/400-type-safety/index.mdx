...
title: '型別安全'
metaTitle: '型別安全'
metaDescription: 'Prisma Client provides full 型別安全 for queries, even for partial queries or included relations. This page explains how to leverage the generated types and utilities.'
tocDepth: 3
---
