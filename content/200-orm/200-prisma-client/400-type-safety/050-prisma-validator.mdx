...
metaDescription: 'The Prisma validator is a utility function that takes a generated 型別 and returns a type-safe 物件 which adheres to the generated types 模型 fields.'
---
