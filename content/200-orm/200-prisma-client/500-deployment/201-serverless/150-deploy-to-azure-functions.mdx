...
metaTitle: 'How to 部署 an app using Prisma ORM to Azure Functions'
metaDescription: '學習如何 to 部署 a Prisma Client based REST API to Azure Functions and connect to an Azure SQL database'
---
