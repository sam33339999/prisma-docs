...
metaTitle: '如何 部署 an app using Prisma ORM to Azure Functions'
metaDescription: '學習如何 to 部署 a Prisma 客戶端 based REST API to Azure Functions and connect to an Azure SQL 資料庫'
---
