...
metaTitle: '部署 Prisma ORM apps to serverless function (FaaS) providers'
metaDescription: '學習如何 to 部署 your Prisma ORM-backed apps to FaaS providers like AWS Lambda, Netlify, or Vercel Serverless Functions'
tocDepth: 2
---
