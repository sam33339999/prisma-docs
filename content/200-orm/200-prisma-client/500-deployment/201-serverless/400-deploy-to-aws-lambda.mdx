...
metaTitle: '部署 your application using Prisma ORM to AWS Lambda'
metaDescription: '學習如何 to 部署 your Prisma ORM-backed applications to AWS Lambda with AWS SAM, Serverless Framework, or SST'
tocDepth: 3
---
