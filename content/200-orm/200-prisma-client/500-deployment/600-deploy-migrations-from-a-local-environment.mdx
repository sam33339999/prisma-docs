---
title: '部署 migrations from a local environment'
metaTitle: '部署 migrations from a local environment'
metaDescription: '學習如何 to 部署 Node.js and TypeScript applications that are using Prisma Client locally.'
tocDepth: 3
---
