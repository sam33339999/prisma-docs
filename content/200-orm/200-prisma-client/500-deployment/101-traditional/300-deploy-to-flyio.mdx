---
title: '部署 to Fly.io'
metaTitle: '部署 a Prisma app to Fly.io'
metaDescription: '學習如何 to 部署 a Node.js server that uses Prisma ORM to Fly.io.'
---


本指南說明如何 deploy a Node.js server that uses Prisma ORM and PostgreSQL to Fly.io.
...
This guide will show you 如何 deploy the same application, without modification, on Fly.io.
...
- Fly.io lets you deploy long-running, "serverful" full-stack applications in [35 regions around the world](https://fly.io/docs/reference/regions/). 預設情況下, applications are configured to to [auto-stop](https://fly.io/docs/launch/autostop-autostart/) when not in use, and auto-start as needed as requests come in.
- Fly.io natively supports a wide variety of [languages and frameworks](https://fly.io/docs/languages-and-frameworks/), including Node.js and Bun. 在本指南中, we'll use the Node.js runtime.
