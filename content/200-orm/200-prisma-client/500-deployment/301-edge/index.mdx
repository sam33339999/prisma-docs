...
metaTitle: '部署 Prisma ORM apps to edge function (distributed FaaS) providers'
metaDescription: '學習如何 to 部署 your Prisma ORM-backed apps to edge functions like Cloudflare Workers or Vercel Edge Functions'
tocDepth: 2
---
