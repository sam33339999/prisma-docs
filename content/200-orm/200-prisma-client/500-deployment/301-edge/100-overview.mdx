...
metaTitle: '概述: 部署 Prisma ORM at the Edge'
metaDescription: '學習如何 to 部署 your Prisma-backed apps to edge functions like Cloudflare Workers or Vercel Edge Functions'
sidebar_label: '概述'
tocDepth: 2
---
