---
title: '部署 to Vercel Edge Functions & Middleware'
metaTitle: '部署 to Vercel Edge Functions & Middleware'
metaDescription: 'Learn the things you need to know in order to 部署 an Edge function that uses Prisma Client for talking to a database.'
