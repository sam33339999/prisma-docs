---
title: '型別 utilities'
metaTitle: 'Prisma 客戶端擴充功能: 型別 utilities'
metaDescription: '進階 型別安全: improve 型別安全 in your 自訂 模型 methods'
---
...
以下範例 creates a new operation, `exists`, based on `findFirst`. It has all of the arguments that `findFirst`.
...
以下範例 illustrates how 您可以 add custom arguments, to a method in an extension:
