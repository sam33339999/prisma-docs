---
title: '讀取 replicas'
metaTitle: '讀取 replicas'
metaDescription: '學習 如何 set up and use 讀取 replicas with Prisma 客戶端'
tocDepth: 3
---
...
The `url` property also accepts an array of values, i.e. an array of all your database replicas you would like 配置:
...
您可以 use the `$primary()` method to explicitly execute a read operation against your primary database:
...
您可以 use the `$replica()` method to explicitly execute your query against a replica instead of your primary database:
