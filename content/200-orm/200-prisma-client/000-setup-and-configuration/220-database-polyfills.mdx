---
title: '資料庫 polyfills'
metaTitle: '資料庫 polyfills (Concepts)'
metaDescription: 'Prisma 客戶端 provides 功能 that are not achievable with relational databases. These 功能 are referred to as "polyfills" and explained on this page.'
