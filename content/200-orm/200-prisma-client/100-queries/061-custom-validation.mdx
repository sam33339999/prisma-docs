...
title: '自訂驗證'
metaTitle: '自訂驗證'
metaDescription: '本頁說明 如何 添加 自訂 驗證 to Prisma 客戶端'
---

<TopBlock>

您可以 add runtime validation for your user input for Prisma Client queries in one of 以下 ways:

- [Prisma Client extensions](/orm/prisma-client/client-extensions)
- A custom function

您可以 use any validation library you'd like. The Node.js ecosystem offers a number of high-quality, easy-to-use validation libraries to choose from including: [joi](https://github.com/sideway/joi), [validator.js](https://github.com/validatorjs/validator.js), [Yup](https://github.com/jquense/yup), [Zod](https://github.com/colinhacks/zod) and [Superstruct](https://github.com/ianstormtaylor/superstruct).
...
The example above shows how 您可以 create a custom type-safe `signup` function that ensures the input is valid before creating a user.

## Going further

- Learn how 您可以 use [Prisma Client extensions](/orm/prisma-client/client-extensions) 添加 input validation for your queries — [example](https://github.com/prisma/prisma-client-extensions/tree/main/input-validation).
- Learn how 您可以 organize your code better by moving the `signup` function into [a custom model](/orm/prisma-client/queries/custom-models).
