---
title: 'SafeQL & Prisma 客戶端'
metaTitle: 'Integrate SafeQL with Prisma 客戶端'
metaDescription: '學習 如何 use SafeQL and Prisma 客戶端 extensions to work around 功能 not natively supported by Prisma, such as PostGIS.'
---
