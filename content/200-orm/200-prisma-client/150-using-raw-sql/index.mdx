---
title: '編寫自己的 SQL'
metaTitle: '在 Prisma 客戶端 中編寫自己的 SQL'
metaDescription: '學習如何在 Prisma 客戶端 中使用原始 SQL 查詢。'
---
...
For a detailed guide on how 開始使用 with TypedSQL, including setup instructions and 使用範例, please 參閱 our [TypedSQL documentation](/orm/prisma-client/using-raw-sql/typedsql).
...
These methods allow you to execute raw MongoDB commands and queries, providing flexibility when 您需要 use MongoDB-specific features or optimizations.
