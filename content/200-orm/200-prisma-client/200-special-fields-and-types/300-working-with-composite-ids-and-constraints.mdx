---
title: '使用 compound IDs and unique constraints'
metaTitle: '使用 compound IDs and unique constraints (Concepts)'
metaDescription: '如何 read, write, and filter by compound IDs and unique constraints.'
tocDepth: 2
---
