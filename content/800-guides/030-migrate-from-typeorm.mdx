---
title: '如何 Migrate from TypeORM to Prisma ORM'
metaTitle: '如何 Migrate from TypeORM to Prisma ORM'
...
本指南向您展示如何 migrate your application from TypeORM to Prisma ORM. We'll use an extended version of the [TypeORM Express example](https://github.com/typeorm/typescript-express-example/) as a [sample project](https://github.com/prisma/migrate-from-typeorm-to-prisma) to demonstrate the migration steps.

This migration guide uses PostgreSQL as the example database, but it equally applies to any other relational database that's [支援 Prisma ORM](/orm/reference/supported-databases). 您可以 learn how Prisma ORM compares to TypeORM on the [Prisma ORM vs TypeORM](/orm/more/comparisons/prisma-and-typeorm) page.
...
Start replacing your TypeORM queries with Prisma Client. Here's an example of 如何 convert some common queries:
...
Update your Express controllers 使用 Prisma Client. 例如, here's how 更新 the `CreateUserAction`:
