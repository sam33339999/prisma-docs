---
title: 'Set up Neon with Accelerate 連線 Pool'
metaTitle: "Set up PostgreSQL on Neon with Prisma Accelerate's 連線 Pool"
...
This guides teaches you 如何 add connection pooling to a PostgreSQL database hosted on [Neon](https://neon.tech/) using [Prisma Accelerate](/accelerate). 
