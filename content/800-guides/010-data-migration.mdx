---
title: 'Migrate 資料 使用 the expand and contract pattern'
metaTitle: '如何 Migrate 資料 with Prisma ORM 使用 the expand and contract pattern'
...
You'll need 安裝 the required packages. If you haven't already, install them using your package manager:
...
Update your schema 添加 the new Status enum and field:
...
Update your schema 移除 the published field:
...
Add 以下 command to your CI/CD pipeline:
...
Now that you've completed your first expand and contract migration, 您可以:
